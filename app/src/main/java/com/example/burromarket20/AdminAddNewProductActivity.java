...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void StoreProductInformation() {
        ...
        loadingbar.setTitle("Añadir producto");
        loadingbar.setMessage("Por favor espera, estamos añadiendo el producto");
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            loadingbar.dismiss();
                            Toast.makeText(AdminAddNewProductActivity.this, "Producto añadido exitosamente...", Toast.LENGTH_SHORT).show();
                        }else{
                            loadingbar.dismiss();
